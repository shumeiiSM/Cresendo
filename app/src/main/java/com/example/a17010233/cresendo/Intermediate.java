...
public class Intermediate extends AppCompatActivity {
    ...
    private void finishQuiz() {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Intermediate.this);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("iscore", thescore);
        editor.putString("idate", cDate);
        editor.putString("itime", cTime);
        editor.commit();
