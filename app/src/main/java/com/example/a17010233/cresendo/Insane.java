...
public class Insane extends AppCompatActivity {
    ...
    private void finishQuiz() {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Insane.this);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("isscore", thescore);
        editor.putString("isdate", cDate);
        editor.putString("istime", cTime);
        editor.commit();
